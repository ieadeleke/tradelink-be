...
// Creates a pending order and returns checkout payload incl. tx_ref
async function initiatePayment(req, res) {
  try {
    ...
    const tx_ref = `TL-${Date.now()}-${Math.floor(Math.random() * 99999)}`;
...
module.exports = { initiatePayment, flutterwaveWebhook };
